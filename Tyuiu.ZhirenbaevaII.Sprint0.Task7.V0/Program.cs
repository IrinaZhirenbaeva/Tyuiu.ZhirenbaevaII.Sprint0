...
using Tyuiu.ZhirenbaevaII.Sprint0.Task7.V0.Lib;

namespace Tyuiu.ZhirenbaevaII.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт №0 | Выполнила: Жиренбаева И.И | ИСТНб-23-1";
            Console.WriteLine("**");
            ...
            Console.WriteLine("Значения элементов мвссива №2");
